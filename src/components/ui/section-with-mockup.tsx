            ...
            <div className="container max-w-[1220px] w-full px-6 md:px-10 relative z-10 mx-auto">
                ...
                >
                    ...
                    >
                        ...
                        <motion.div
                             className={`absolute w-[300px] h-[317px] md:w-[472px] md:h-[500px] bg-muted/20 rounded-[32px] z-0`}
                             style={{
                        ...
                        >
                            <div
                                className="relative w-full h-full bg-cover bg-center rounded-[32px] border border-border"
                                style={{
                        ...
                        {/* Main Mockup Card */}
                        <motion.div
                            className="relative w-full h-[405px] md:h-[637px] bg-card/80 rounded-[32px] backdrop-blur-[15px] backdrop-brightness-[100%] border border-border z-10 overflow-hidden shadow-2xl"
                            initial={{ y: reverseLayout ? 0 : 0 }}
                            whileInView={{ y: reverseLayout ? 20 : 30 }}
